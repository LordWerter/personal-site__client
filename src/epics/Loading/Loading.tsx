  ...
  return (
    <CWrap sizeId={sizeId} theme={theme.cwrap}>
      ...
      <TextBlock sizeId={sizeId} theme={theme.textblock}>
        {!!langs?.title && <Title sizeId={sizeId} theme={theme.title}>{langs.title}</Title>}
        {!!langs?.shortDescription && <ShortDescription sizeId={sizeId} theme={theme.shortdescription}>{langs.shortDescription}</ShortDescription>}
      </TextBlock>
      </ContentArea>
    </CWrap>
  );
